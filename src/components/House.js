...
const House = ({house}) => {
  ...
  return <div className='bg-white shadow-1 p-5 rounded-lg rounded-t1-[90px] w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition'>
       <img className='mb-8 ' src={image} alt='Coming Soon!!!' />
